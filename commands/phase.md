...
- Look for the plan document in that feature directory as "PLAN.md"
- If no current feature is set, look for "PLAN.md" in the root directory

I want you to implement **$ARGUMENTS** of the implementation plan. This is part of a larger feature that we're building incrementally, with each step building on the previous one.

Please refer to the DESIGN.md and REQUIREMENTS.md documents (in the same directory as the PLAN.md you're working with) for any questions about implementation.
